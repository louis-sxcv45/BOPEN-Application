...
class NonAsnDetailPage extends StatefulWidget {
  final String documentId;
  final String? collectionName;

  const NonAsnDetailPage({super.key, required this.documentId, this.collectionName});

  @override
  State<NonAsnDetailPage> createState() => _NonAsnDetailPageState();
}

class _NonAsnDetailPageState extends State<NonAsnDetailPage> {
  ...
  String _formatCollectionName(String collectionName) {
    ...
    // Ekstrak angka dari nama koleksi (misal: penilaian_non_asn_2 -> 2)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Detail Pegawai Non ASN'),
      ),
                ...
                children: [
                  ...
                  ...hasilPenilaian.asMap().entries.map((entry) {
                    ...
                    return FutureBuilder<String>(
                      future: _getNamaPenilai(emailPenilai),
                      builder: (context, snapshot) {
                        return Card(
                          elevation: 4,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildScoreItem(
                                  'Disiplin',
                                  detailPenilaian['disiplin']?.toString() ?? '0',
                                  Colors.blue,
                                ),
                                _buildScoreItem(
                                  'Orientasi Pelayanan',
                                  detailPenilaian['orientasi_pelayanan']?.toString() ?? '0',
                                  Colors.green,
                                ),
                                _buildScoreItem(
                                  'Inovatif',
                                  detailPenilaian['inovatif']?.toString() ?? '0',
                                  Colors.orange,
                                ),
                                _buildScoreItem(
                                  'Penampilan, Kecakapan, Kerjasama, dan Tanggung Jawab',
                                  detailPenilaian['penampilan']?.toString() ?? '0',
                                  Colors.purple,
                                ),
                                const Divider(thickness: 1.5),
                                _buildTotalScore(
