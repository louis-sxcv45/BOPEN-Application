...
class NonAsnAssessmentHistoryPage extends StatefulWidget {
  const NonAsnAssessmentHistoryPage({super.key});

  @override
  State<NonAsnAssessmentHistoryPage> createState() => _NonAsnAssessmentHistoryPageState();
}

class _NonAsnAssessmentHistoryPageState extends State<NonAsnAssessmentHistoryPage> {
  ...
  Future<void> _deleteCollection(String collectionName) async {
    ...
    if (confirm) {
      try {
        ...
        print('Error during deletion process: $e'); // Debug log
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Riwayat Penilaian Non ASN'),
      ),
