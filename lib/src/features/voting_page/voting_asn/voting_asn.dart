...
class _VotingDataASNState extends State<VotingDataASN> {
  final SingleValueDropDownController namaKaryawanController = SingleValueDropDownController();
  ...
  Future<void> _loadPegawaiData() async {
    try {
      final querySnapshot = await FirebaseFirestore.instance.collection('asn').get();
      if (mounted) {
        setState(() {
                      ...
                      child: Column(
                        ...
                        children: [
                          DropDownTextField(
                            ...
                            onChanged: (value) {
                              if (value != null) {
                                final selectedValue = value.value as Map<String, dynamic>;
                                setState(() {
